...
<div style="text-align:center">
    <img src="/figures/mcculloch_fig1.jpg" width="350">
</div>
...
<div style="text-align:center">
    <img src="/figures/Mark1.png" width="350">
</div>
...
<p style="text-align: center;">Illustration of a conv neuron, from [13]. Kernel in the figure correspond to the learnt weights of the neuron. This particular neuron is connected to 9 neurons (3x3) from the previous layer.</p>
...
The convolution process as a whole can be understood as the definition of a kernel window which is slided over the whole input to produce a set of outputs. See the next figure for a visual example.
